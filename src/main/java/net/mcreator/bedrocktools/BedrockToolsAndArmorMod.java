package net.mcreator.bedrocktools;
...
@Mod("bedrock_tools_and_armor")
public class BedrockToolsAndArmorMod {
	public static final Logger LOGGER = LogManager.getLogger(BedrockToolsAndArmorMod.class);
	public static final String MODID = "bedrock_tools_and_armor";

	public BedrockToolsAndArmorMod() {
